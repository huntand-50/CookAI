...
<?php endif; ?>
            <?php if ($__user): ?>
                ...
                <a href="<?= url('profile') ?>" class="flex items-center gap-2">
                    <img src="<?= e($__user['avatar_url'] ?: 'https://png.pngtree.com/png-vector/20240723/ourmid/pngtree-illustration-of-comma-symbol-as-a-bakery-chef-png-image_12954265.png') ?>" class="w-9 h-9 rounded-full object-cover ring-2 ring-amber-200" alt="Профиль">
                </a>
            <?php else: ?>
