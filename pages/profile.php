...
<section class="max-w-5xl mx-auto px-4 sm:px-6 py-8">
    <div class="bg-white rounded-3xl shadow-md p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-6" data-aos="fade-up">
        <img src="<?= e($u['avatar_url'] ?: 'https://png.pngtree.com/png-vector/20240723/ourmid/pngtree-illustration-of-comma-symbol-as-a-bakery-chef-png-image_12954265.png') ?>" class="w-24 h-24 rounded-full object-cover ring-4 ring-amber-100" alt="Аватар">
